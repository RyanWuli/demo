...
/**
 * Create by Ryan on 2021/4/13 23:01
 * Version 1.0
 * Description 地址：https://blog.csdn.net/wo541075754/article/details/81673517
 */
...
//        String c = idToCode(1339833064108462080L);
//        System.out.println("邀请码：" + c);
//        Long id = codeToId(c);
//        System.out.println("用户 id：" + id);
        String c = idToCode(5L);
        System.out.println("邀请码：" + c);
        Long id = codeToId(c);
        System.out.println("用户 id：" + id);
    }
